...
const SearchBar: React.FC = () => {
  const { toggleShowFilters, showFilters, searchString, updateFilters, triggerSearch } = useFiltersStore();
  return (
    <div className="max-w-10xl mx-auto w-full flex items-center py-8 desktop:px-[105px] laptop:px-[75px] px-6 mt-10 gap-4">
      ...
      <button 
        ...
        className="h-20 w-72 bg-brand-yellow rounded-5xl hover:bg-brand-yellow/90 transition-colors flex items-center justify-center gap-5 text-brand-neutral cursor-pointer text-3xl"
      >
